...
I use =00-obscureIPv6Prefix= to hide my IPv6 prefix when sharing terminal output online.
If you don't want this feature, you can:
- Disable it by renaming: =mv 00-obscureIPv6Prefix _00-obscureIPv6Prefix=
- Or remove all occurrences of =| obscureIPv6= in =99-ip= and =00-obscureIPv6Prefix=
